          ...
          {filteredProjects.map((project, index) => {
            ...
            return (
              <div
                ...
                className={`project-card-anim group relative rounded-3xl overflow-hidden bg-white/80 dark:bg-[#0e111a]/90 border border-slate-200/90 dark:border-white/10 backdrop-blur-xl shadow-sm hover:shadow-2xl hover:border-violet-500/40 dark:hover:border-cyan-400/40 transition-all duration-300 flex flex-col ${
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 left-4 flex flex-wrap gap-2">
                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-violet-600 text-white shadow-md backdrop-blur-md">
                      {project.badge || project.category}
                    </span>
                    {project.modules && (
                      <span className="px-3 py-1 rounded-full text-xs font-semibold bg-emerald-600/90 text-white shadow-md backdrop-blur-md hidden sm:inline-block">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 sm:left-6 sm:right-6">
                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white group-hover:text-cyan-300 transition-colors">
                      {project.title}
                    </h3>
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-5">
                  ...
                  <div className="pt-4 border-t border-slate-200 dark:border-white/10 flex items-center justify-between gap-3">
                    ...
                    <button
                      onClick={() => setActiveModalProject(project)}
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-violet-600 dark:text-cyan-400 hover:underline cursor-pointer"
                    >
        ...
        {activeModalProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative max-w-4xl w-full my-6 bg-white dark:bg-[#0f121d] border border-slate-200 dark:border-white/15 rounded-3xl shadow-2xl overflow-hidden z-10 max-h-[92vh] flex flex-col"
            >
              {/* Modal Header / Banner */}
              <div className="relative h-56 sm:h-72 bg-slate-900 shrink-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0f121d] via-black/50 to-transparent"></div>

                {/* Close Button */}
                <button
                  onClick={() => setActiveModalProject(null)}
                  className="absolute top-4 right-4 p-2.5 rounded-full bg-black/60 text-white hover:bg-black transition cursor-pointer z-10"
                ...
                <div className="absolute bottom-4 left-6 right-6">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-violet-600 text-white inline-block">
              ...
              <div className="px-6 pt-4 pb-2 border-b border-slate-200 dark:border-white/10 bg-slate-50/70 dark:bg-white/[0.02] overflow-x-auto flex gap-2 shrink-0">
                <button
              ...
              <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-slate-700 dark:text-zinc-300">
                      ...
                      <div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-2.5">
                          {activeModalProject.features.map((feature, i) => (
                            <div
                              key={i}
                              className="p-3 rounded-xl bg-slate-50/70 dark:bg-white/[0.02] border border-slate-200/60 dark:border-white/5 flex items-start gap-2.5 text-xs sm:text-sm"
                            >
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {activeModalProject.modules.map((module, i) => (
                        <div
                          key={i}
                          className="p-5 rounded-2xl bg-slate-50/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 space-y-3"
                        >
                          <div className="flex items-center justify-between gap-2">
                            <h5 className="font-bold text-slate-900 dark:text-white text-sm sm:text-base">
                              {module.title}
                            </h5>
                            <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-violet-500/10 text-violet-600 dark:text-cyan-400 border border-violet-500/20">
                              {module.badge}
                            </span>
                          </div>
                          <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-300 leading-relaxed">
                          ...
                          <div className="p-2.5 rounded-xl bg-violet-500/5 dark:bg-cyan-500/5 border border-violet-500/15 dark:border-cyan-500/15 text-xs text-slate-700 dark:text-zinc-200">
                            <strong className="text-violet-600 dark:text-cyan-400">Highlight:</strong> {module.highlight}
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    {activeModalProject.designSystem && (
                      <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-500/5 via-violet-500/5 to-emerald-500/5 border border-slate-200 dark:border-white/10 space-y-3">
                        <div className="flex items-center gap-2 text-sm font-bold text-slate-900 dark:text-white">
                        ...
                        <div className="flex flex-wrap items-center gap-2 pt-1">
                          ...
                          {activeModalProject.designSystem.colors.map((c, idx) => (
                            <span
                              key={idx}
                              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-800 dark:text-zinc-200"
                            >
                              <span
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10">
                      <div className="divide-y divide-slate-200 dark:divide-white/10">
                        {activeModalProject.techStackBreakdown.map((row, idx) => (
                          <div
                            key={idx}
                            className="p-4 bg-slate-50/50 dark:bg-white/[0.02] flex flex-col sm:flex-row sm:items-center justify-between gap-2"
                          >
                            <span className="text-xs font-bold uppercase tracking-wider text-violet-600 dark:text-cyan-400 sm:w-44 shrink-0">
                              {row.layer}
                            </span>
                            <span className="text-xs sm:text-sm text-slate-700 dark:text-zinc-200 flex-1">
                              {row.stack}
                            </span>
                          </div>
                        ))}
                ...
                {/* TAB 4: INTERVIEW & ENGINEERING HIGHLIGHTS */}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {activeModalProject.engineeringHighlights.map((qna, idx) => (
                        <div
                          key={idx}
                          className="p-5 rounded-2xl bg-slate-50/80 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 space-y-2"
                        >
                ...
                {modalTab === "resume" && activeModalProject.resumeBullets && (
                  <div className="space-y-6">
                      ...
                      <button
                        ...
                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition shadow-sm cursor-pointer ${
                          copiedAllBullets
                            ...
                            : "bg-slate-100 dark:bg-white/10 hover:bg-violet-600 hover:text-white text-slate-800 dark:text-zinc-200"
                        }`}
                      >
                        {copiedAllBullets ? (
                          <>
                    ...
                    <div className="p-4 rounded-2xl bg-slate-100 dark:bg-[#07090e] border border-slate-200 dark:border-white/10 font-mono text-xs text-slate-800 dark:text-zinc-200">
                      <p className="font-bold text-violet-600 dark:text-cyan-400 mb-1">
                        {activeModalProject.title}
                      </p>
                      ...
                      <div className="space-y-3 font-sans">
                        {activeModalProject.resumeBullets.map((bullet, idx) => (
                          <div
                            key={idx}
                            className="group p-3 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/5 flex items-start justify-between gap-3 hover:border-violet-500/40 transition"
                          >
                            ...
                            <button
                              ...
                              className={`shrink-0 p-2 rounded-lg text-xs font-semibold transition cursor-pointer ${
                                copiedBulletIndex === idx
                                  ...
                                  : "text-slate-400 group-hover:text-violet-600 dark:group-hover:text-cyan-400 hover:bg-slate-100 dark:hover:bg-white/10"
                              }`}
                              title="Copy bullet"
                            >
