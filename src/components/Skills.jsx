...
const skillCategories = [
  {
    ...
    skills: [
      { name: "React / React 19", level: 92, note: "Hooks, Context, Custom Hooks" },
      { name: "JavaScript (ES6+)", level: 90, note: "Async/Await, DOM, Closures" },
      { name: "Tailwind CSS", level: 95, note: "v4, Responsive, Design Tokens" },
      { name: "HTML5 / Semantic UI", level: 95, note: "SEO & Accessibility" },
      { name: "Redux Toolkit", level: 85, note: "Global Store & Slices" },
  ...
  },
  {
    ...
    skills: [
      { name: "Node.js", level: 88, note: "Event Loop, Streams, File System" },
      { name: "Express.js", level: 88, note: "Routing, Middleware, Controllers" },
      { name: "MongoDB & Mongoose", level: 85, note: "Aggregations, Schemas, Indexing" },
      { name: "RESTful API Architecture", level: 90, note: "CRUD, Status Codes, Versioning" },
      { name: "JWT & OAuth Authentication", level: 88, note: "Token Security, Cookies, RBAC" },
    ],
  },
  {
    id: "tools",
    ...
    description: "Version control, testing, workflow automation, and deployment.",
    skills: [
      { name: "Git & GitHub", level: 88, note: "Branching, PRs, Merge Workflows" },
      { name: "Postman", level: 85, note: "API Testing, Collections, Env" },
      { name: "Vite & Build Tooling", level: 90, note: "Bundling, Code Splitting" },
      { name: "Firebase", level: 78, note: "Authentication, Firestore" },
      { name: "Vercel & Cloud Deploy", level: 85, note: "CI/CD, Domain & Env Config" },
    ],
  },
  {
    id: "languages",
    ...
    description: "Strong foundation in data structures, algorithms, and SQL.",
    skills: [
      { name: "TypeScript", level: 78, note: "Types, Interfaces, Generics" },
      { name: "Python", level: 78, note: "Scripting, Logic, Fundamentals" },
      { name: "SQL (MySQL/Postgres)", level: 75, note: "Queries, Joins, Constraints" },
      { name: "C Programming", level: 70, note: "Pointers, Memory, Data Structures" },
